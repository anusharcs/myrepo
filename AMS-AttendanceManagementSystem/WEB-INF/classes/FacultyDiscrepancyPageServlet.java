...
public class FacultyDiscrepancyPageServlet extends HttpServlet  
{
  ...
  public void doGet(HttpServletRequest request , HttpServletResponse res) throws ServletException,  IOException  
  {
        ...
        if(session == null){
            ...
            try{
                ...
                code="<table> <tr> <th>Student ID</th> <th>Active Course ID</th> <th>Session ID</th> <th>Justification</th> <th>Status</th></tr>";
                String query="{call proc_get_faculty_discrepancy(?)}";
                ...
                while(rs.next()){
                    ...
                    if(stat.equals("applied")){
                        ...
                        app = app + "<form id='" + id +"'> <tr id='" + id+"table"+"'> <td><input type='text' name='stuid' value='" + stu_id +"' readonly></td>" + "<td><input type='text' name='acid' value='" + acid +"' readonly></td>" + "<td><input type='text' name=''sessid' value='" + sess_id +"' readonly></td>" + "<td><input type='text' name='just' value='" + just +"' readonly></td>" + "<td><input type='button' name='approve' value='Approve' id='"+ id+"approved"+ "'onclick=\"discprocess('approved','"+ id+"')\"> <input type='button' value='Deny' name='deny' id='"+ id+"denied"+"'onclick=\"discprocess('denied','"+ id+"')\"></td></tr></form>";
                    }
                    else{
                        done=done +"<tr><td>"+stu_id+"</td>"+"<td>"+acid+"</td>"+"<td>"+sess_id+"</td><td>"+just+"</td><td>"+stat+"</td></tr>";
                    }
                }
