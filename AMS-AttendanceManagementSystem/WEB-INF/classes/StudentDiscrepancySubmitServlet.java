...
public class StudentDiscrepancySubmitServlet extends HttpServlet  
{
  ...
  public void doGet(HttpServletRequest request , HttpServletResponse res) throws ServletException,  IOException  
  {
        ...
        if(session == null){
            ...
            try{
                ...
                String query="{call proc_apply_discrepancy(?,?,?,?)}";
            ...
            RequestDispatcher rd = request.getRequestDispatcher("./StudentDiscrepancyHome.html");
